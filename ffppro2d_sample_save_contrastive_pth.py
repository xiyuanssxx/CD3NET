...
from ffp2d_seedV_overlap_contrastive_pth import Configs
# from ffp2d_seedV_overlap import Configs
...
class ArcMarginHead(nn.Module):
    ...
    def __init__(self, in_features, out_features,
                 load_backbone='/HOME/scz5346/run/xiaoye/DS-DDPM-main/assets/max_acc.pth', s=30.0, m=0.50,
                 easy_margin=False):
...
class Sampler:
    ...
    def sample_save_data(self, n_frames: int = 1000, create_video: bool = False, overlap_cover=True, debug=False,
                         subject_id=1, batch_size=64, mix_batch_size = 9, mix_trail = 144):
        """
        ...
        data_sampled_path = '/media/administrator/F62C65672C652439/yexiyuan/sample_data/bci2a'
...
def main():
    ...
    run_uuid = "d8561a4424d511ef8eb689b82d07b24d"
    # Start an evaluation
    experiment.evaluate()
    # Create configs
    configs = Configs()
    ...
    with experiment.start():
        ...
        with torch.no_grad():
            ...
            for i in range(1):
                # sampler.sample_animation(n_frames=1, subject_id = [i], dataroot='./pltresults')
                # sampler.sample_save_data(n_frames=20, subject_id=i, batch_size=mix_batch_size*mix_trail,
                #                          mix_batch_size = mix_batch_size, mix_trail = mix_trail)
                sampler.sample_save_data(n_frames=20, subject_id=i, batch_size=144*9)
