...
from ffp2d_seedV_overlap_contrastive import Configs
    ...
    def sample_save_data(self, n_frames: int = 1000, create_video: bool = False, overlap_cover=True, debug=False,
        ...
        if overlap_cover:
            ...
            for i in range(x0.shape[3]):
                ...
                real_noises[:, :, 0 + i * self.step: self.window_size + i * self.step] = x0_noise[:, :, :, i]
                real_mix[:, :, 0 + i * self.step: self.window_size + i * self.step] = x_mix[:, :, :, i]
        data_sampled_path = 'contrast-experiments-progan-contrastive/'
...
def main():
    ...
    run_uuid = "950f0bbea92f11eebbc301d122615e25"
    # Start an evaluation
    experiment.evaluate()
    # Create configs
    configs = Configs()
    ...
    with experiment.start():
        ...
        with torch.no_grad():
            ...
            for i in range(9):
                ...
                sampler.sample_save_data(n_frames=20, subject_id=i, batch_size=144)
