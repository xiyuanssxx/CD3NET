...
class ArcMarginHead(nn.Module):
    ...
    def __init__(self, in_features, out_features, load_backbone='./assets/attention-SEEDV/max_acc.pth', s=30.0, m=0.50,
                 easy_margin=False):
...
def datasetLoader_BCI_IV_mix_subjects(c: Configs):
    ...
    Create BCI IV dataset
    """
    return DatasetLoader_BCI_IV_mix_subjects('train', datafolder='./dataset/SEED-IV/motor4')
