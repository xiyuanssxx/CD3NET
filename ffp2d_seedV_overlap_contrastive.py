...
from src.EEGNet import EEG_Net_8_Stack as EEGNET
...
# from plt import compute_spectrogram,plot_spectrograms
...
class ArcMarginHead(nn.Module):
    ...
    def __init__(self, in_features, out_features, load_backbone='./assets/attention-MI/max_acc.pth', s=30.0, m=0.50,
                 easy_margin=False):
        ...
        self.orieegnet = EEGNET(mtl=False)
...
# '/home/lichunyu/Downloads/xiaohei/DS-DDPM-main/data/single_sep (1)/single_sep(1)1-T'
            ...
            # test_X = data["test_x"][:, :, 750:1500]  # [trials, channels, time length]
            train_X = data["train_x"][:1 ,:, 750:1500]
...
def datasetLoader_BCI_IV_mix_subjects(c: Configs):
    ...
    Create BCI IV dataset
    """
    return DatasetLoader_BCI_IV_mix_subjects('train', datafolder='./dataset/bci2a/motor1')
